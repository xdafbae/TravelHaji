    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
                ...
                <p class="text-sm text-secondary-500 mt-1 font-medium">Perbarui informasi jadwal keberangkatan</p>
            </div>
        ...
        <form action="{{ route('embarkasi.update', $embarkasi->id_embarkasi) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="bg-white overflow-hidden shadow-sm rounded-2xl border border-secondary-100">
                        <div class="px-6 py-4 border-b border-secondary-100 bg-secondary-50/50 flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-secondary-500">Detail paket haji/umroh</p>
                            </div>
                        </div>
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <select id="paket_haji_umroh" name="paket_haji_umroh" class="tom-select block w-full text-sm rounded-xl border-secondary-300 focus:border-primary-500 focus:ring-primary-500" required placeholder="Pilih Paket..." onchange="updatePrice(this)">
                                    ...
                                    @foreach($priceLists as $pl)
                                        <option value="{{ $pl->nama_item }}" data-harga="{{ $pl->harga }}" {{ old('paket_haji_umroh', $embarkasi->paket_haji_umroh) == $pl->nama_item ? 'selected' : '' }}>
                                            {{ $pl->nama_item }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="kota_keberangkatan" class="block w-full pl-10 text-sm rounded-xl border-secondary-300 focus:border-primary-500 focus:ring-primary-500 shadow-sm" type="text" name="kota_keberangkatan" value="{{ old('kota_keberangkatan', $embarkasi->kota_keberangkatan) }}" required />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="kapasitas_jamaah" class="block w-full pl-10 text-sm rounded-xl border-secondary-300 focus:border-primary-500 focus:ring-primary-500 shadow-sm" type="number" name="kapasitas_jamaah" value="{{ old('kapasitas_jamaah', $embarkasi->kapasitas_jamaah)" required min="1" />
                                </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="hidden" id="harga_paket" name="harga_paket" value="{{ old('harga_paket', $embarkasi->harga_paket) }}">
                                </div>
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="waktu_keberangkatan" class="flatpickr block w-full pl-10 border-secondary-300 focus:border-primary-500 focus:ring-primary-500 rounded-xl shadow-sm text-sm" type="text" name="waktu_keberangkatan" value="{{ old('waktu_keberangkatan', $embarkasi->waktu_keberangkatan ? $embarkasi->waktu_keberangkatan->format('Y-m-d H:i') : '') }}" required placeholder="Pilih tanggal..." />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="waktu_kepulangan" class="flatpickr block w-full pl-10 border-secondary-300 focus:border-primary-500 focus:ring-primary-500 rounded-xl shadow-sm text-sm" type="text" name="waktu_kepulangan" value="{{ old('waktu_kepulangan', $embarkasi->waktu_kepulangan ? $embarkasi->waktu_kepulangan->format('Y-m-d H:i') : '') }}" placeholder="Pilih tanggal..." />
                                </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="maskapai" class="block w-full pl-10 text-sm rounded-xl border-secondary-300 focus:border-primary-500 focus:ring-primary-500 shadow-sm" type="text" name="maskapai" value="{{ old('maskapai', $embarkasi->maskapai) }}" placeholder="Contoh: Garuda Indonesia" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="pesawat_pergi" class="block w-full pl-10 text-sm rounded-xl border-secondary-300 focus:border-primary-500 focus:ring-primary-500 shadow-sm" type="text" name="pesawat_pergi" value="{{ old('pesawat_pergi', $embarkasi->pesawat_pergi) }}" placeholder="Contoh: GA-980" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="pesawat_pulang" class="block w-full pl-10 text-sm rounded-xl border-secondary-300 focus:border-primary-500 focus:ring-primary-500 shadow-sm" type="text" name="pesawat_pulang" value="{{ old('pesawat_pulang', $embarkasi->pesawat_pulang) }}" placeholder="Contoh: GA-981" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select id="status" name="status" class="border-secondary-300 focus:border-primary-500 focus:ring-primary-500 rounded-xl shadow-sm block w-full pl-10 text-sm">
                                        <option value="Belum Berangkat" {{ old('status', $embarkasi->status) == 'Belum Berangkat' ? 'selected' : '' }}>Belum Berangkat</option>
                                        <option value="Sudah Berangkat" {{ old('status', $embarkasi->status) == 'Sudah Berangkat' ? 'selected' : '' }}>Sudah Berangkat</option>
                                        <option value="Selesai" {{ old('status', $embarkasi->status) == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                    </select>
                                </div>
                                ...
                                <div class="relative z-50">
                                    ...
                                    <select id="id_tour_leader" name="id_tour_leader" class="tom-select block w-full pl-10 text-sm rounded-xl border-secondary-300 focus:border-primary-500 focus:ring-primary-500" placeholder="Pilih Tour Leader...">
                                        ...
                                        @foreach($tourLeaders as $tl)
                                            <option value="{{ $tl->id_pegawai }}" {{ old('id_tour_leader', $embarkasi->id_tour_leader) == $tl->id_pegawai ? 'selected' : '' }}>
                                                {{ $tl->nama_pegawai }}
                                            </option>
                                        @endforeach
                                    </select>
    ...
    <script>
        ...
        function updatePrice(selectElement) {
            ...
            if(originalOption) {
                ...
                if (harga) {
                    // Animasi flash pada input harga
                    ...
                    // Cek jika harga sudah diisi dan berbeda
                    if(hargaInput.value && hargaInput.value != harga) {
                         if(confirm('Ubah harga paket sesuai data master?')) {
