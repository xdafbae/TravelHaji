                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="kota_keberangkatan" class="block w-full pl-10 text-sm rounded-xl" type="text" name="kota_keberangkatan" :value="old('kota_keberangkatan', $embarkasi->kota_keberangkatan)" required />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="kapasitas_jamaah" class="block w-full pl-10 text-sm rounded-xl" type="number" name="kapasitas_jamaah" :value="old('kapasitas_jamaah', $embarkasi->kapasitas_jamaah)" required min="1" />
                                </div>
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="waktu_keberangkatan" class="flatpickr block w-full pl-10 border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm text-sm" type="text" name="waktu_keberangkatan" value="{{ old('waktu_keberangkatan', $embarkasi->waktu_keberangkatan ? $embarkasi->waktu_keberangkatan->format('Y-m-d H:i') : '') }}" required placeholder="Pilih tanggal..." />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="waktu_kepulangan" class="flatpickr block w-full pl-10 border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm text-sm" type="text" name="waktu_kepulangan" value="{{ old('waktu_kepulangan', $embarkasi->waktu_kepulangan ? $embarkasi->waktu_kepulangan->format('Y-m-d H:i') : '') }}" placeholder="Pilih tanggal..." />
                                </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="maskapai" class="block w-full pl-10 text-sm rounded-xl" type="text" name="maskapai" :value="old('maskapai', $embarkasi->maskapai)" placeholder="Contoh: Garuda Indonesia" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="pesawat_pergi" class="block w-full pl-10 text-sm rounded-xl" type="text" name="pesawat_pergi" :value="old('pesawat_pergi', $embarkasi->pesawat_pergi)" placeholder="Contoh: GA-980" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="pesawat_pulang" class="block w-full pl-10 text-sm rounded-xl" type="text" name="pesawat_pulang" :value="old('pesawat_pulang', $embarkasi->pesawat_pulang)" placeholder="Contoh: GA-981" />
                                </div>
