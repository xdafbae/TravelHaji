<x-app-layout>
                ...
                <form action="{{ route('embarkasi.update', $embarkasi->id_embarkasi) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="kota_keberangkatan" class="block mt-1 w-full" type="text" name="kota_keberangkatan" :value="old('kota_keberangkatan', $embarkasi->kota_keberangkatan)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="waktu_keberangkatan" class="block mt-1 w-full" type="datetime-local" name="waktu_keberangkatan" :value="old('waktu_keberangkatan', $embarkasi->waktu_keberangkatan ? $embarkasi->waktu_keberangkatan->format('Y-m-d\TH:i') : '')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="waktu_kepulangan" class="block mt-1 w-full" type="datetime-local" name="waktu_kepulangan" :value="old('waktu_kepulangan', $embarkasi->waktu_kepulangan ? $embarkasi->waktu_kepulangan->format('Y-m-d\TH:i') : '')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="maskapai" class="block mt-1 w-full" type="text" name="maskapai" :value="old('maskapai', $embarkasi->maskapai)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="harga_paket" class="block mt-1 w-full" type="number" name="harga_paket" :value="old('harga_paket', $embarkasi->harga_paket)" required min="0" />
                        ...
                        <div>
                            ...
                            <x-text-input id="kapasitas_jamaah" class="block mt-1 w-full" type="number" name="kapasitas_jamaah" :value="old('kapasitas_jamaah', $embarkasi->kapasitas_jamaah)" required min="1" />
                    ...
                    <div class="mt-4 border-t pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="pesawat_pergi" class="block mt-1 w-full" type="text" name="pesawat_pergi" :value="old('pesawat_pergi', $embarkasi->pesawat_pergi)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="pesawat_pulang" class="block mt-1 w-full" type="text" name="pesawat_pulang" :value="old('pesawat_pulang', $embarkasi->pesawat_pulang)" />
    ...
    <script>
        function updatePrice(selectElement) {
            ...
            // Only update price if a valid package is selected
            if (harga) {
                // Optional: ask for confirmation if price is already set
