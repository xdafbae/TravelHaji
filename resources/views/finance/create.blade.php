<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                ...
                <div class="bg-gray-50/50 px-8 py-6 border-b border-gray-100">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Isi detail transaksi pemasukan atau pengeluaran dengan lengkap.</p>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <label class="cursor-pointer relative group">
                                            <input type="radio" name="jenis" value="Debet" class="peer sr-only" {{ old('jenis') == 'Debet' ? 'checked' : '' }} onchange="toggleJamaahField()">
                                        ...
                                        <label class="cursor-pointer relative group">
                                            <input type="radio" name="jenis" value="Kredit" class="peer sr-only" {{ old('jenis') == 'Kredit' ? 'checked' : '' }} onchange="toggleJamaahField()">
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <input type="date" name="tanggal" id="tanggal" class="pl-10 block w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors" value="{{ old('tanggal', date('Y-m-d')) }}" required>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1 group">
                                        ...
                                        <input type="text" name="jumlah_display" id="jumlah_display" class="pl-10 block w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm font-mono text-lg font-semibold text-gray-700 transition-colors" value="{{ old('jumlah') }}" required placeholder="0" oninput="formatRupiah(this)">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="keterangan" id="keterangan" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors" value="{{ old('keterangan') }}" required placeholder="Contoh: Pembayaran Listrik">
                        ...
                        <div class="mt-8 space-y-6 bg-gray-50/50 p-6 rounded-xl border border-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <textarea id="deskripsi" name="deskripsi" rows="4" class="block mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors" placeholder="Tambahkan detail jika diperlukan...">{{ old('deskripsi') }}</textarea>
    ...
    <script>
        function toggleJamaahField() {
            // Optional: Add logic to show/hide jamaah field based on transaction type if needed
            // Currently keeps it visible as per requirement, or add specific logic here.
        }
