                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <x-text-input id="nama_pegawai" class="block w-full pl-10 rounded-xl border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm" type="text" name="nama_pegawai" :value="old('nama_pegawai')" required autofocus autocomplete="name" placeholder="Masukkan nama lengkap pegawai" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <x-text-input id="jabatan" class="block w-full pl-10 rounded-xl border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm" type="text" name="jabatan" :value="old('jabatan')" placeholder="Contoh: Staff Admin" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <x-text-input id="no_hp" class="block w-full pl-10 rounded-xl border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm" type="text" name="no_hp" :value="old('no_hp')" placeholder="08..." />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <x-text-input id="tim_syiar" class="block w-full pl-10 rounded-xl border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm" type="text" name="tim_syiar" :value="old('tim_syiar')" placeholder="Nama tim syiar" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <x-text-input id="wilayah" class="block w-full pl-10 rounded-xl border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm" type="text" name="wilayah" :value="old('wilayah')" placeholder="Nama wilayah" />
                                </div>
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative group">
                                    ...
                                    <x-text-input id="username" class="block w-full pl-10 rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm" type="text" name="username" :value="old('username')" required autocomplete="username" placeholder="Username login" />
                                </div>
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative group">
                                    ...
                                    <x-text-input id="password" class="block w-full pl-10 rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
                                </div>
