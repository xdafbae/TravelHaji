                ...
                <form action="{{ route('pegawai.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="nama_pegawai" class="block mt-1 w-full" type="text" name="nama_pegawai" :value="old('nama_pegawai')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="jabatan" class="block mt-1 w-full" type="text" name="jabatan" :value="old('jabatan')" placeholder="Contoh: Staff Admin, Tour Leader" />
                        ...
                        <div>
                            ...
                            <x-text-input id="tim_syiar" class="block mt-1 w-full" type="text" name="tim_syiar" :value="old('tim_syiar')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="wilayah" class="block mt-1 w-full" type="text" name="wilayah" :value="old('wilayah')" />
